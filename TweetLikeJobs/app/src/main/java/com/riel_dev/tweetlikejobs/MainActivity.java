...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(settingsFragment.preferences.getBoolean("notification",false)){
        ...
        isAlreadyLoggedInToTwitter = PreferenceManager.getBoolean(getApplicationContext(),"login");
        if(isAlreadyLoggedInToTwitter){
            ...
            configurationBuilder.setOAuthAccessToken(PreferenceManager.getString(getApplicationContext(), "access_token"));
            configurationBuilder.setOAuthAccessTokenSecret(PreferenceManager.getString(getApplicationContext(), "access_secret"));
                ...
                public void run() {
                    try {
                        ...
                        *       - Then change by shared preference                                */
                        ...
                        PreferenceManager.setString(getApplicationContext(), "profilePicUrl", profilePicUrl);
        ...
        if(PreferenceManager.getString(getApplicationContext(), "profilePicUrl") != null) {
            Log.d("Profile Pic Url", PreferenceManager.getString(getApplicationContext(), "profilePicUrl"));
            RequestOptions requestOptions = new RequestOptions();
            requestOptions = requestOptions.transform(new CenterCrop(), new RoundedCorners(20));
            Glide.with(MainActivity.this)
                    .load(Uri.parse(PreferenceManager.getString(getApplicationContext(), "profilePicUrl")))
